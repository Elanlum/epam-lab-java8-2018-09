...
public class Exercise1 {
    ...
    public void mapEmployeesToLengthOfTheirFullNames() {
      ...
      Function<Employee, Integer> fullNameLengthExtractor = employee -> stringLengthExtractor.compose(fullNameExtractor).compose(personExtractor).apply(employee);
      Function<Employee, Integer> fullNameLengthExtractor1 = employee -> personExtractor.andThen(fullNameExtractor).andThen(stringLengthExtractor).apply(employee);
